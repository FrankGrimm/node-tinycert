...
var TinyCertSession = function TinyCertSession(apiKey) {
    ...
    */
    var signedRequest = function signedRequest(route, params) {
        ...
        return 'https://www.tinycert.org/api/v1' + route + '?' + qs + '&digest=' + calculatedHash;
    };
    ...
    var apiRequest = function apiRequest(route, params, cb) {
        ...
        var fullurl = signedRequest(route, params);
